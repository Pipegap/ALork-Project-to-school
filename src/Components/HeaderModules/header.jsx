...
function Header (props) {
    return (
        <header className={classes.header}>
            ...
            <NavLink to="/profile" className={classes.avatarLink}><img src={props.store.getState().profilePage.infoUser[0].photos.small} alt="" className={classes.userAva}/></NavLink>
        </header>
    )
};
